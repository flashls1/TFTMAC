...
async function consumeDirectControlRequest() {
  ...
  const allowed = new Set(['inventory', 'prepare', 'engineering-map-selftest', 'lab-selftest', 'build', 'launch-app', 'open-play-web', 'runtime-process-audit', 'cleanup-tftmac-adb-residue', 'single-runtime-preflight', 'launch-mactician-control', 'stop-mactician-control', 'mactician-runtime-audit', 'cleanup-observer-adb-5037', 'start', 'start-donor-control', 'start-donor-control-5gb', 'start-donor-control-5gb-flush400', 'play-action', 'play-probe', 'gles-capability-probe', 'launch-failure-probe', 'recover-anr-wait', 'logger-health', 'restart-game', 'preplay-optimize', 'restart-effect-analysis', 'analyze-latest-closed-run-trends', 'compare-latest-runs', 'screen-state-probe', 'reveal-lock-screen', 'wake-guest-screen', 'audio-health', 'audio-backend-probe', 'disconnect-window-audit', 'runtime-fault-audit', 'graphics-pipeline-audit', 'analyze-session', 'ingest-analysis', 'trace-capabilities', 'native-trace-smoke', 'native-trace-combat', 'presentation-probe', 'window-inventory', 'fit-window', 'play-certification', 'play-diagnose', 'google-account-ui', 'image-check', 'device-profiles', 'image-upgrade-start', 'image-upgrade-status', 'launch-game', 'status', 'marker', 'game-settings','quality-report','match-boundary-probe','analyze-approx-match','ingest-approx-match', 'match-entry', 'combat-start', 'first-place', 'stop', 'package-state', 'package-launch-probe', 'auth-brief', 'install-diagnose', 'play-install-brief', 'play-store-repair']);
