...
const expectedHead = '3326792efc694e853312aa7347abcb1edd96575a';
const planRoot = '.clara/plans/tftmac-causal-graphics-v1';
const waveRoot = `${planRoot}/wave-b-v4`;
const expected = {
  ...
  [`${waveRoot}/CORRECTION_AMENDMENT.md`]: '18e85884498c52144f3e56217eb372b78289b6d938c5c92c0459a35882296b15',
  [`${waveRoot}/PREFLIGHT.json`]: '6e8e415d921d0517d00a82101125340f109f9ca8bd3824b9ab9a130939054cfe',
  [`${waveRoot}/ZENGATE_RECEIPT.json`]: '35c9fbf5e295fd33a4ead854da72a3ac972620f4a4cd0205f5e6ebaa03b06c49',
  [`${waveRoot}/RuntimeMode.swift.template`]: 'e57dafefcd8d1cbdc20dc5494b02b81736bf23d8c53006ecedc87c8b37259aa7',
  [`${waveRoot}/RuntimeLease.swift.template`]: 'f2a8f06ede29f06c57f038fd94f48047cd796ccf138d05b1d2e0bdd0de160cdc',
  [`${waveRoot}/RuntimeModeAuthority.swift.template`]: '3ab10d59a94ef4e60e920290a940a55a624a0209a7fe6e05abe65fdfaf040c59',
  [`${waveRoot}/validate-waveb-v4.mjs`]: '594ed6fce8c4897c1db83d90a425973805e2590267ea10bb29dc24550194a724',
...
function fail(message) { console.error(`WAVE_B_V4_APPLY_FAILED: ${message}`); process.exit(1); }
...
function writeAtomic(relativePath, content, mode = 0o644) {
  ...
  const temporary = `${destination}.waveb-v4-${process.pid}`;
...
const modeTemplate = readText(`${waveRoot}/RuntimeMode.swift.template`);
...
const runtimeLeaseSource = readText(`${waveRoot}/RuntimeLease.swift.template`);
...
`;
runtime = replaceSection(runtime, '    nonisolated private static func processMatchesLaunchedIdentity(', '    nonisolated private static func controllerDiscoveryRoots', processHelpers, 'process identity helpers');
...
`  ssot/runtime-authority.json \\
  ...
  ${waveRoot}/validate-waveb-v4.mjs \\
  ssot/retained-evidence-index.json \\`,
...
`node --check tools/tftmac-direct-control.mjs >/dev/null
node --check ${waveRoot}/validate-waveb-v4.mjs >/dev/null`,
'validator syntax');
verifier = replaceOnce(verifier,
...
node ${waveRoot}/validate-waveb-v4.mjs >/dev/null
...
const receipt = {
  schema: 1,
  state: 'WAVE_B_V4_IMPLEMENTATION_APPLIED',
  project_id: 'tftmac',
  change_id: changeId,
  ...
  correction_amendment_sha256: expected[`${waveRoot}/CORRECTION_AMENDMENT.md`],
