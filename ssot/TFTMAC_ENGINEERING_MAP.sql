...
('current_performance_priority','Record graphics preset/FPS cap/Performance Mode with native frame timing first; test Performance Mode one factor at a time; test FPS cap one factor at a time; test graphics preset one factor at a time; only then test guest RAM 6144->4096 MB and deeper renderer/transport changes.'),
