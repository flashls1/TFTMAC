...
[[ "$TEST_FUNCTION_COUNT" == "77" ]] || fail "native test inventory drifted: expected 77, found $TEST_FUNCTION_COUNT"
...
print "TFTMAC source validation: OK (unsigned Release build; 77 native tests; startup splash bundled; DEV startup + diagnostic source authority; diagnostic mode source authority PASS)"
