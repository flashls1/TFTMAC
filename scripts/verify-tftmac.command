...
[[ "$TEST_FUNCTION_COUNT" == "73" ]] || fail "native test inventory drifted: expected 73, found $TEST_FUNCTION_COUNT"
...
print "TFTMAC source validation: OK (unsigned Release build; 73 native tests; startup splash bundled; DEV startup + diagnostic source authority; diagnostic mode source authority PASS)"
