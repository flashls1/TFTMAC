...
[[ "$TEST_FUNCTION_COUNT" == "54" ]] || fail "native test inventory drifted: expected 54, found $TEST_FUNCTION_COUNT"
...
print "TFTMAC source validation: OK (unsigned Release build; 54 native tests; diagnostic mode source authority PASS)"
